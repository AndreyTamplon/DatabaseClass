CREATE TABLE IF NOT EXISTS factory.workshops (
         	"id" serial NOT NULL,
...
CREATE TABLE IF NOT EXISTS factory.sections (
         	"id" serial NOT NULL,
         	"name" character varying(150) NOT NULL,
         	"workshop_id" integer NOT NULL,
         	"section_leader" integer NOT NULL,
         	CONSTRAINT "sections_pk" PRIMARY KEY ("id")
         ) WITH (
           OIDS=FALSE
         );

CREATE TABLE IF NOT EXISTS factory.product_types (
         	"id" serial NOT NULL,
         	"type" character varying(150) NOT NULL,
         	"subtype" character varying(150),
...
CREATE TABLE IF NOT EXISTS factory.job_attributes (
         	"id" serial NOT NULL,
         	"name" character varying(150) NOT NULL,
         	"value" TEXT,
...
CREATE TABLE IF NOT EXISTS factory.employees (
         	"id" serial NOT NULL,
         	"name" character varying(150) NOT NULL,
         	"job_id" integer NOT NULL,
         	"manager_id" integer,
...
CREATE TABLE IF NOT EXISTS factory.brigades (
         	"id" serial NOT NULL,
         	"name" character varying(150) NOT NULL,
...
CREATE TABLE IF NOT EXISTS factory.laboratory (
         	"id" serial NOT NULL,
         	"name" character varying(150) NOT NULL UNIQUE,
...
CREATE TABLE IF NOT EXISTS factory.workshops_n_labs (
         	"workshop_id" integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS factory.equipment (
         	"id" serial NOT NULL,
         	"name" character varying(150) NOT NULL,
         	"laboratory_id" integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS factory.testing_history (
         	"id" serial NOT NULL,
...
CREATE TABLE IF NOT EXISTS factory.brigade_employees (
...
CREATE TABLE IF NOT EXISTS factory.production_history (
         	"id" serial NOT NULL,
         	"product_id" integer NOT NULL,
         	"section_id" integer NOT NULL,
         	"brigade_id" integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS factory.job_history (
         	"employee_id" integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS factory.laboratorians_n_tests (
...
CREATE TABLE IF NOT EXISTS factory.equipment_n_tests (
...
CREATE TABLE IF NOT EXISTS factory.product_completion_history (
...
CREATE TABLE IF NOT EXISTS factory.test_completion_history (
         	"test_id" integer NOT NULL,
         	"end_time" timestamp with time zone NOT NULL
         ) WITH (
           OIDS=FALSE
...
ALTER TABLE "sections" ADD CONSTRAINT "sections_fk1" FOREIGN KEY ("section_leader") REFERENCES "employees"("id");
ALTER TABLE "product_attributes" ADD CONSTRAINT "product_attributes_fk0" FOREIGN KEY ("product_id") REFERENCES "products"("id");
